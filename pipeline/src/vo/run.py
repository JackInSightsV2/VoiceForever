...
# Approval actions (approve/reject a Candidate, regenerate an Archetype) belong to `vo prepare`, and NPC Voice re-rolls
# (the Separation page) to `vo voices`; both are left for them. Other dashboard actions (fix lexicon, ...) land with
# their tickets; until then they stay unconsumed.
